...
function obterCampaignsManifestPath()
{
    ...
    {
        return normalizarCaminhoLocal(manifest.trim());
    }
    ...
    if (dataPath != null && dataPath.trim() !== "")
    {
        ...
        return `${caminhoData}/campaigns.json`;
    }

    return "./data/campaigns.json";
}

function normalizarCaminhoLocal(caminho)
{
...
async function obterCampanhaInicial(manifesto)
{
    ...
    {
        campaignLoader.salvarCampanha(campanhaEscolhida);
    }
